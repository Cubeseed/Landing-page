...
import styles from './join_provider.module.scss'
  ...
  return (
    <div>
        ...
        <div className={styles.join_main_title}>
            ...
            <h2>Establish a connection with farms and provide agricultural services</h2>
        </div>
        <div className={styles.box}>
            <div className={styles.leaf}>
                <h4>Please answer the additional questions to help us get to know you.</h4>
                <h5>User Type: <span>Ag Service Provider</span></h5>
                <form className={styles.main_form}>
                    <label>Types of Agro-service</label>
                    <input type="text"  />
              </form>
